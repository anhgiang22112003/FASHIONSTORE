...
import './addproduct.css' // Đường dẫn tương đối
            ...
            <div className="flex-1 lg:overflow-y-auto lg:pr-4 space-y-8 pb-8 scrollbar-hidden">
                ...
                <div className="bg-white p-8 rounded-2xl shadow-xl space-y-6">
                    ...
                    <label className="block space-y-2">
                        ...
                        <input type="text" placeholder="Nhập tên sản phẩm" className="w-full px-4 py-3 border border-pink-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-200" />
                    </label>
                    <label className="block space-y-2">
                        <span className="text-gray-600">Mô tả ngắn gọn về sản phẩm</span>
                        <input type="text" placeholder="Mô tả ngắn gọn" className="w-full px-4 py-3 border border-pink-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-200" />
                    </label>
                    <label className="block space-y-2">
                        <span className="text-gray-600">Mô tả chi tiết</span>
                        <textarea placeholder="Mô tả chi tiết sản phẩm, chất liệu, cách sử dụng..." rows="5" className="w-full px-4 py-3 border border-pink-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-200 resize-none"></textarea>
                    </label>
                </div>
                ...
                <div className="bg-white p-8 rounded-2xl shadow-xl space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <label className="block space-y-2">
                            ...
                            <input type="number" placeholder="₫" className="w-full px-4 py-3 border border-pink-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-200" />
                        </label>
                        <label className="block space-y-2">
                ...
                <div className="bg-white p-8 rounded-2xl shadow-xl space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <label className="block space-y-2">
                            ...
                            <select className="w-full px-4 py-3 border border-pink-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-200">
                        ...
                        <label className="block space-y-2">
                            ...
                            <input type="text" placeholder="Nhập thương hiệu" className="w-full px-4 py-3 border border-pink-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-200" />
                        </label>
                    </div>
                    <label className="block space-y-2">
                        <span className="text-gray-600">Tags</span>
                        <div className="flex items-center space-x-2">
                            <input type="text" placeholder="Thêm tag mới" className="w-full px-4 py-3 border border-pink-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-200" />
                ...
                <div className="bg-white p-8 rounded-2xl shadow-xl space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <label className="block space-y-2">
                            ...
                            <input type="number" placeholder="0" className="w-full px-4 py-3 border border-pink-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-200" />
                        </label>
                        <label className="block space-y-2">
                            <span className="text-gray-600">Mã (SKU) sản phẩm</span>
                            <input type="text" placeholder="PF001" className="w-full px-4 py-3 border border-pink-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-200" />
                        </label>
                    </div>
                    <div className="space-y-2">
                        ...
                        <div className="flex items-center space-x-6">
                            <label className="inline-flex items-center space-x-2">
                                <input type="radio" name="status" value="Còn hàng" defaultChecked className="text-pink-600 focus:ring-pink-500" />
                                <span>Còn hàng</span>
                            </label>
                            <label className="inline-flex items-center space-x-2">
                                <input type="radio" name="status" value="Hết hàng" className="text-pink-600 focus:ring-pink-500" />
                                <span>Hết hàng</span>
                            </label>
                            <label className="inline-flex items-center space-x-2">
                                <input type="radio" name="status" value="Ngừng bán" className="text-pink-600 focus:ring-pink-500" />
                                <span>Ngừng bán</span>
                            </label>
                        </div>
                    </div>
            ...
            <div className="w-full lg:w-96 flex-shrink-0 space-y-6 lg:mt-0">
                <div className="bg-white p-8 rounded-2xl shadow-xl space-y-4 sticky ">
                    ...
                    <div className="space-y-1">
                        <p className="font-semibold text-gray-800">Tên sản phẩm</p>
                        <p className="text-sm text-gray-500">Mô tả ngắn gọn sẽ hiển thị ở đây</p>
                    </div>
                    <div className="flex items-center space-x-2">
                        <p className="text-lg font-bold text-pink-600">0₫</p>
                        <p className="text-sm text-gray-400 line-through">0₫</p>
                    </div>
