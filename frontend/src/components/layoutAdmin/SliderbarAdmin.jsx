        ...
        >
            ...
            `}>
                ...
                <button
                    ...
                    className="p-2 rounded-full text-var(--text-color) hover:bg-gray-100 hover:text-pink-600 transition-colors"
                >
                ...
                {navItems.map((item) => (
                    <a
                        ...
                        className={`
                            ...
                            ${activeTab === item.id ? 'bg-pink-600 text-var(--text-color) font-semibold' : 'text-var(--text-color) hover:bg-pink-50 hover:text-pink-600'}
